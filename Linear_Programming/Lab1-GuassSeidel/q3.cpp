/*
    ...
    Q3. Find all Basic Solutions of the given system of equation using Guass Seidel Equation
        Given conditions that all X[i] >= 0 
        implies we have to find BASIC FEASIBLE SOLUTION
*/

/*
    THE code is same as in question 2
    But I iterate over each and every basic solution
    if all of them are positive - then that set of solution is Feasibe (BFS)
    so displaying in next line that Feasible solution
*/
